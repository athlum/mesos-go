...
func NewPopulatedCall_Accept(r randyScheduler, easy bool) *Call_Accept {
	...
	if r.Intn(10) != 0 {
		v18 := r.Intn(5)
		this.Operations = make([]mesos.Offer_Operation, v18)
		for i := 0; i < v18; i++ {
			v19 := mesos.NewPopulatedOffer_Operation(r, easy)
			this.Operations[i] = *v19
		}
	}
	if r.Intn(10) != 0 {
...
func NewPopulatedCall_Decline(r randyScheduler, easy bool) *Call_Decline {
	...
	if r.Intn(10) != 0 {
		v20 := r.Intn(5)
		this.OfferIDs = make([]mesos.OfferID, v20)
		for i := 0; i < v20; i++ {
...
func NewPopulatedCall_DeclineInverseOffers(r randyScheduler, easy bool) *Call_DeclineInverseOffers {
	...
	if r.Intn(10) != 0 {
		v24 := r.Intn(5)
		this.InverseOfferIDs = make([]mesos.OfferID, v24)
		for i := 0; i < v24; i++ {
			v25 := mesos.NewPopulatedOfferID(r, easy)
			this.InverseOfferIDs[i] = *v25
		}
	}
	if r.Intn(10) != 0 {
		this.Filters = mesos.NewPopulatedFilters(r, easy)
...
func NewPopulatedCall_Revive(r randyScheduler, easy bool) *Call_Revive {
	this := &Call_Revive{}
	if r.Intn(10) != 0 {
		v26 := string(randStringScheduler(r))
		this.Role = &v26
	}
	if !easy && r.Intn(10) != 0 {
	}
...
func NewPopulatedCall_Shutdown(r randyScheduler, easy bool) *Call_Shutdown {
	...
	this.ExecutorID = *v28
	v29 := mesos.NewPopulatedSlaveID(r, easy)
	this.SlaveID = *v29
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedCall_Acknowledge(r randyScheduler, easy bool) *Call_Acknowledge {
	...
	v30 := mesos.NewPopulatedSlaveID(r, easy)
	this.SlaveID = *v30
	v31 := mesos.NewPopulatedTaskID(r, easy)
	this.TaskID = *v31
	v32 := r.Intn(100)
	this.UUID = make([]byte, v32)
	for i := 0; i < v32; i++ {
...
func NewPopulatedCall_Reconcile(r randyScheduler, easy bool) *Call_Reconcile {
	...
	if r.Intn(10) != 0 {
		v33 := r.Intn(5)
		this.Tasks = make([]Call_Reconcile_Task, v33)
		for i := 0; i < v33; i++ {
			v34 := NewPopulatedCall_Reconcile_Task(r, easy)
			this.Tasks[i] = *v34
		}
	}
	if !easy && r.Intn(10) != 0 {
...
func NewPopulatedCall_Reconcile_Task(r randyScheduler, easy bool) *Call_Reconcile_Task {
	...
	v35 := mesos.NewPopulatedTaskID(r, easy)
	this.TaskID = *v35
	if r.Intn(10) != 0 {
		this.SlaveID = mesos.NewPopulatedSlaveID(r, easy)
	}
...
func NewPopulatedCall_Message(r randyScheduler, easy bool) *Call_Message {
	this := &Call_Message{}
	v36 := mesos.NewPopulatedSlaveID(r, easy)
	this.SlaveID = *v36
	v37 := mesos.NewPopulatedExecutorID(r, easy)
	this.ExecutorID = *v37
	v38 := r.Intn(100)
...
func NewPopulatedCall_Request(r randyScheduler, easy bool) *Call_Request {
	...
	if r.Intn(10) != 0 {
		v39 := r.Intn(5)
		this.Requests = make([]mesos.Request, v39)
		for i := 0; i < v39; i++ {
			v40 := mesos.NewPopulatedRequest(r, easy)
			this.Requests[i] = *v40
		}
	}
	if !easy && r.Intn(10) != 0 {
...
func NewPopulatedCall_Suppress(r randyScheduler, easy bool) *Call_Suppress {
	this := &Call_Suppress{}
	if r.Intn(10) != 0 {
		v41 := string(randStringScheduler(r))
		this.Role = &v41
	}
	if !easy && r.Intn(10) != 0 {
	}
...
func randFieldScheduler(dAtA []byte, r randyScheduler, fieldNumber int, wire int) []byte {
	...
	case 0:
		...
		dAtA = encodeVarintPopulateScheduler(dAtA, uint64(v43))
	case 1:
		dAtA = encodeVarintPopulateScheduler(dAtA, uint64(key))
...
var fileDescriptorScheduler = []byte{
	...
	,
}
