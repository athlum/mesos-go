...
func TestSlaveInfo_CapabilityProto(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedSlaveInfo_Capability(popr, false)
	dAtA, err := github_com_gogo_protobuf_proto.Marshal(p)
	if err != nil {
		t.Fatalf("seed = %d, err = %v", seed, err)
	}
	msg := &SlaveInfo_Capability{}
	if err := github_com_gogo_protobuf_proto.Unmarshal(dAtA, msg); err != nil {
		t.Fatalf("seed = %d, err = %v", seed, err)
	}
	littlefuzz := make([]byte, len(dAtA))
...
func TestSlaveInfo_CapabilityMarshalTo(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedSlaveInfo_Capability(popr, false)
	size := p.Size()
...
func BenchmarkSlaveInfo_CapabilityProtoMarshal(b *testing.B) {
	popr := math_rand.New(math_rand.NewSource(616))
	total := 0
	pops := make([]*SlaveInfo_Capability, 10000)
	for i := 0; i < 10000; i++ {
		pops[i] = NewPopulatedSlaveInfo_Capability(popr, false)
	}
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		dAtA, err := github_com_gogo_protobuf_proto.Marshal(pops[i%10000])
...
func BenchmarkSlaveInfo_CapabilityProtoUnmarshal(b *testing.B) {
	popr := math_rand.New(math_rand.NewSource(616))
	total := 0
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		dAtA, err := github_com_gogo_protobuf_proto.Marshal(NewPopulatedSlaveInfo_Capability(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
...
func TestSlaveInfo_CapabilityJSON(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedSlaveInfo_Capability(popr, true)
	marshaler := github_com_gogo_protobuf_jsonpb.Marshaler{}
	jsondata, err := marshaler.MarshalToString(p)
	if err != nil {
		t.Fatalf("seed = %d, err = %v", seed, err)
...
func TestSlaveInfo_CapabilityProtoText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedSlaveInfo_Capability(popr, true)
	dAtA := github_com_gogo_protobuf_proto.MarshalTextString(p)
...
func TestSlaveInfo_CapabilityProtoCompactText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedSlaveInfo_Capability(popr, true)
	dAtA := github_com_gogo_protobuf_proto.CompactTextString(p)
...
func TestSlaveInfo_CapabilityVerboseEqual(t *testing.T) {
	popr := math_rand.New(math_rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedSlaveInfo_Capability(popr, false)
	dAtA, err := github_com_gogo_protobuf_proto.Marshal(p)
	if err != nil {
...
func TestSlaveInfo_CapabilityGoString(t *testing.T) {
	popr := math_rand.New(math_rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedSlaveInfo_Capability(popr, false)
	s1 := p.GoString()
	s2 := fmt.Sprintf("%#v", p)
...
func TestSlaveInfo_CapabilitySize(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedSlaveInfo_Capability(popr, true)
	size2 := github_com_gogo_protobuf_proto.Size(p)
...
func BenchmarkSlaveInfo_CapabilitySize(b *testing.B) {
	popr := math_rand.New(math_rand.NewSource(616))
	total := 0
	pops := make([]*SlaveInfo_Capability, 1000)
	for i := 0; i < 1000; i++ {
		pops[i] = NewPopulatedSlaveInfo_Capability(popr, false)
	}
	b.ResetTimer()
...
func TestSlaveInfo_CapabilityStringer(t *testing.T) {
	popr := math_rand.New(math_rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedSlaveInfo_Capability(popr, false)
	s1 := p.String()
	s2 := fmt.Sprintf("%v", p)
